                        ...
                        <nav class="horizontalMenu clearfix">
                            <ul class="horizontalMenu-list">
                                ...
                                <li aria-haspopup="true">
									...
									<ul class="sub-menu">
										<li aria-haspopup="true"><a href="{{url('/lead')}}">Lead</a></li>										
									</ul>
                                </li>
								...
								<li aria-haspopup="true">
										<a href="{{url('/')}}" class="sub-icon">
											...
											BVS <i class="fa fa-angle-down horizontal-icon"></i>
										</a>
										<ul class="sub-menu">											
										<li aria-haspopup="true"><a href="{{url('/')}}">Dashboard</a></li>
										<li aria-haspopup="true"><a href="{{url('/applicants')}}">Applicants</a></li>
										<li aria-haspopup="true"><a href="{{url('/qclist')}}">QC Verification</a></li>
										<li aria-haspopup="true"><a href="{{url('/verificationlist')}}"> Verification</a></li>											
										<li aria-haspopup="true"><a href="{{url('/dashboard/entrydashboard')}}"> Data Entry</a></li>
										</ul>
									</li>
                               <!-- <li aria-haspopup="true">
                                    <a href="{{ url('/sbiresidence') }}" class="sub-icon">
                                        <svg class="hor-icon" xmlns="http://www.w3.org/2000/svg" height="24"
                                            viewBox="0 0 24 24" width="24">
                                            <path d="M0 0h24v24H0V0z" fill="none" />
                                            <path
