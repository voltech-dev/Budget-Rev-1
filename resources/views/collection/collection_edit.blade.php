                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody name='abc' id='abc'>
                                    ...
                                    <tr>
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->mayactual_total}}" disabled></td>
                                        @endif
                                        <td><input type="text" style="width:60px"
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->junactual_total}}" disabled></td>
                                        @endif
                                        <td><input type="text" style="width:60px"
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->julactual_total}}" disabled></td>
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->augactual_total}}" disabled></td>
                                        @endif
                                        <td><input type="text" style="width:60px"
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->sepactual_total}}" disabled></td>
                                        @endif
                                        <td><input type="text" style="width:60px"
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->octactual_total}}" disabled></td>
                                        @endif
                                        ...
                                        @else
                                        <td><input type="text" style="width:60px;"
                                                value="{{$collection->novactual_total}}" disabled></td>
                                        @endif
                                        ...
                                        @if(empty($collection->actual_total))
