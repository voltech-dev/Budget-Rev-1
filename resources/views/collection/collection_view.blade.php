...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ url('/collectionupdate/'.$target->id) }}" method="POST">
            @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select id="company_name" class="form-control form-control-sm" name="company_name" disabled>
                            ...
                            <option value="{{$collection->Company_name}}" selected readonly>{{$collection->Company_name}}
                            </option>
                    ...
                    <div class="col-sm-3">
                        <select id="division" class="form-control form-control-sm" name="division">
                            ...
                            <option value="{{$collection->division}}" selected>{{$collection->division}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <select id="unit" class="form-control form-control-sm" name="unit" disabled="true">
                            <option value="{{$collection->unit}}" selected>{{$collection->unit}}</option>
                    ...
                    <div class="col-sm-3">
                        <select name="financial_year" class="form-control form-control-sm" id="financial_year"
                            disabled="true">
                            <option value="{{$collection->financial_year}}" selected>{{$collection->financial_year}}</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-sm" name="region" id="region"
                            value="{{$collection->region}}" readonly>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
